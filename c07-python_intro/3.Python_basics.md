...
We can, however, create the equivalent of Java's print() function using the optional `end` named parameter:
```Python
print("Hello", end="")
```
...
When we save and run this new script, we get index out of range exception:
