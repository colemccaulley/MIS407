...
Pass comment is basically a *do nothing* statement. It is used where syntax dictates that a statement must exist, but you have no reason to include a statement.
